...
public class ClinicaServico {
    ...
    public void cadastrarProfissional(String nome, String especialidade)
        ...
        profissionaisPorNome.put(nome, profissional);
    ...
    public void agendarConsulta(String cpfPaciente, String nomeProfissional, String data, String horario)
        ...
        if (!profissional.atendeNoDia(diaSemana)) {
            throw new HorarioIndisponivelException("Profissional nao atende no dia: " + data
                    + ". Dias disponiveis: " + diasDisponiveisFormatados(profissional));
        }
        ...
        Consulta consulta = new Consulta(cpfPaciente, nomeProfissional, data, horario);
    ...
    public void remarcarConsulta(int indice, String novaData, String novoHorario)
        ...
        original.remarcar();
        Consulta nova = new Consulta(original.cpfPaciente, original.nomeProfissional,
    ...
    public Consulta buscarConsulta(String cpf, String data, String horario)
        ...
        for (Consulta c : consultas) {
            if (c.cpfPaciente.equals(cpf) && c.data.equals(data) && c.horario.equals(horario)) {
                return c;
            }
        }
    ...
    private String diasDisponiveisFormatados(Profissional profissional) {
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < profissional.getTotalDias(); i++) {
            if (i > 0) sb.append(", ");
            sb.append(profissional.getDiaDisponivel(i));
        }
        return sb.toString();
    }
